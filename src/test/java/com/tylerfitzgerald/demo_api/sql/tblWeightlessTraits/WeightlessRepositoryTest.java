...
public class WeightlessRepositoryTest {
  ...
  //            .build();
  //    Mockito.when(jdbcTemplate.queryForStream(WeightlessTraitRepository.READ_SQL,
  // beanPropertyRowMapper))
  //        .thenReturn(Stream.of(weightlessTraitDTO, weightlessTraitDTO2));
  //    List<WeightlessTraitDTO> tokens = new WeightlessTraitRepository(jdbcTemplate,
  // beanPropertyRowMapper).read();
  //    Mockito.verify(jdbcTemplate, Mockito.times(1))
  ...
  //            .build();
  //    Mockito.when(
  //            jdbcTemplate.queryForStream(WeightlessTraitRepository.READ_BY_ID_SQL,
  // beanPropertyRowMapper, ID))
  //        .thenReturn(Stream.of(weightlessTraitDTO));
  //    WeightlessTraitDTO tokenDTOResult = new WeightlessTraitRepository(jdbcTemplate,
  // beanPropertyRowMapper).readById(ID);
  //    Mockito.verify(jdbcTemplate, Mockito.times(1))
  ...
  //    WeightlessTraitDTO tokenDTOResults =
  //        new WeightlessTraitRepository(jdbcTemplate,
  // beanPropertyRowMapper).update(weightlessTraitDTO);
  //    Mockito.verify(jdbcTemplate, Mockito.times(1))
  //        .queryForStream(WeightlessTraitRepository.READ_BY_ID_SQL, beanPropertyRowMapper,
  // TOKEN_ID);
  //    Mockito.verify(jdbcTemplate, Mockito.times(0))
