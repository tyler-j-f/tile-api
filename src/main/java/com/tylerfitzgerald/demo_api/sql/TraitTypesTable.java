...
public class TraitTypesTable implements TableInterface {
     ...
     */
    private static final String CREATE_SQL  = "CREATE TABLE tblTraitTypes(id int NOT NULL AUTO_INCREMENT, traitTypeId int, traitTypeName VARCHAR(2083), description VARCHAR(2083), PRIMARY KEY (id))";
    private static final String DELETE_SQL  = "DROP TABLE tblTraitTypes";
