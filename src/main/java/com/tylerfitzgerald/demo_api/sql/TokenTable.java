...
public class TokenTable implements TableInterface {
    ...
    private static final String CREATE_SQL = "CREATE TABLE " + TABLE_NAME + "(id int NOT NULL AUTO_INCREMENT, tokenId int, saleId int, name VARCHAR(2083), description VARCHAR(2083), externalUrl VARCHAR(2083), imageUrl VARCHAR(2083), PRIMARY KEY (id))";
